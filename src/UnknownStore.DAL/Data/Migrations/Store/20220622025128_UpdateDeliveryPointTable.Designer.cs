...
namespace UnknownStore.DAL.Data.Migrations.Store
{
    ...
    [Migration("20220622025128_UpdateDeliveryPointTable")]
    partial class UpdateDeliveryPointTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.DeliveryPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.WorkDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.BuyModel", b =>
                {
                    ...
                    b.HasOne("UnknownStore.DAL.Entities.Store.Order", "Order")
                        .WithMany("BuyModels")
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.DeliveryPoint", b =>
                {
                    b.HasOne("UnknownStore.DAL.Entities.Store.Address", "Address")
                        .WithOne("DeliveryPoint")
                        .HasForeignKey("UnknownStore.DAL.Entities.Store.DeliveryPoint", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.Factory", b =>
                {
                    b.HasOne("UnknownStore.DAL.Entities.Store.Address", "Address")
                        .WithOne("Factory")
                        .HasForeignKey("UnknownStore.DAL.Entities.Store.Factory", "AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UnknownStore.DAL.Entities.Store.WorkDay", b =>
                {
                    b.HasOne("UnknownStore.DAL.Entities.Store.DeliveryPoint", "DeliveryPoint")
                        .WithMany("WorkDays")
